...
exports.create = function create(userData) {
  ...
  return co(function* () {
    ...
    searchQuery = { phone_number: userData.phone_number };
    let existsByPhoneNumber = yield exports.get(searchQuery);

    if(existsByPhoneNumber) {
      let err = new Error('User With The Phone Number Already Exists');
